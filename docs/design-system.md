...
- split-screen режим должен ощущаться как единый рабочий холст, а не как две конкурирующие фичи;
- mindmap-панель остаётся вторичной по визуальному весу относительно таблицы: она помогает видеть структуру, но не перехватывает основную иерархию внимания;
- автоматическое наведение mindmap на editing context должно быть заметным, но спокойным: без резких скачков, вспышек и декоративных анимаций;
