...
const baseItem = (partial: Partial<WorkItem>): WorkItem => ({
  id: partial.id ?? "id",
  workspaceId: partial.workspaceId ?? "default-workspace",
  title: partial.title ?? "title",
  object: partial.object ?? null,
  possiblyRemovable: partial.possiblyRemovable ?? false,
  ...
  updatedAt: partial.updatedAt ?? new Date("2024-01-01T00:00:00.000Z"),
})
